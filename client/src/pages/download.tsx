      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-8">
          ...
          <div className="max-w-md mx-auto space-y-4 mb-6">
            ...
            <Button
              ...
              className="w-full font-medium py-4 text-lg shadow-lg"
            >
        ...
        <div className="flex justify-center mb-8">
          <div className="relative">
            <div className="w-32 h-32 rounded-full border-8 border-green-500 flex items-center justify-center bg-green-50 shadow-lg">
          ...
          <div className="ml-6 flex flex-col justify-center">
            <p className="text-gray-700 mb-1">
              Your images are now <span className="font-semibold text-green-600">{totalSavings}% smaller!</span>
            </p>
